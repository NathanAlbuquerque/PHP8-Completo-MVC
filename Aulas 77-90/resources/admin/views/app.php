...
<head>
  <!-- Color -->
  <script src="{{ url('resources/admin/js/color-modes.js') }}"></script>
  <!-- Meta tags -->
  <meta charset="UTF-8">
  ...
  <link href="{{ url('resources/general/pluguins/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
  <style>
    .bd-placeholder-img {
      font-size: 1.125rem;
      text-anchor: middle;
  ...
  <!-- Custom styles for this template -->
  <link href="{{ url('resources/admin/css/dashboard.css') }}" rel="stylesheet">
</head>
...
<body>
  ...
  <script src="{{ url('resources/general/pluguins/bootstrap/bootstrap.bundle.min.js') }}"></script>

  <script src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js" integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp" crossorigin="anonymous"></script>
  <script src="{{ url('resources/admin/js/dashboard.js') }}"></script>
</body>
